...
export default function App() {
  ...
  useEffect (() => {
    // if (position) {
      ...
      axios.get(`https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${position.lat},${position.lng}&radius=2000&type=restaurant&
      ...
      .then(res => {
        ...
        allRestaurants = restaurants.concat(googleRestaurants)
